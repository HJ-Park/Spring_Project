		...
		<div class="xet_container">
			...
			<div class="xet_content">
					...
					<div class="viewDocument">
						<div class="boardRead">
							...
							<div class="boardNavigation">
								...
								<c:if test="${sessionScope == board.id}">
									<div class="float_left">
										<form action="boardmodify" method="get">
											<input type="hidden" name="boardseq" value="">
										</form>
										<a href="/sixth/modify?boardseq=${board.boardseq}"
				...
				<form action="boardwrite_modify_on" method="post">
					...
					제목:
					<textarea cols="50" rows="1" name="boardtitle">${board.boardtitle}</textarea>
					<br> 내용:
					<textarea cols="50" rows="30" name="boardcontent">${board.boardcontent}</textarea>
					<br>
